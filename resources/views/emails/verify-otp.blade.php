...
<head>
    ...
    <style>
        ...
        .brand { font-weight:700; color:#111827; letter-spacing:.2px; }
        .greeting { margin:0 0 12px; color:#111827; font-size:18px; }
        .line { color:#374151; margin:8px 0; }
        .otp { font-size:30px; letter-spacing:6px; font-weight:800; color:#111827; text-align:center; margin:22px 0; padding:16px; border:1px dashed #d1d5db; border-radius:10px; background:#f9fafb; }
