...
<head>
    ...
    <style>
        ...
        #wallet-balance { font-size: 24px; font-weight: bold; margin: 20px 0; }
...
<body>
    ...
    <script>
        ...
        if (!tx_ref) {
                ...
                fetch(`/api/check-payment-status?tx_ref=${tx_ref}`)
                    ...
                    .then(data => {
                        if (data.status === 'success') {
                            ...
                            document.getElementById('status').innerHTML = '⚠️ Payment confirmed but balance update delayed';
                            document.getElementById('wallet-balance').innerHTML = 
            ...
            // Also try manual processing
            fetch('/api/process-payment-manually', {
                method: 'POST',
                headers: {
